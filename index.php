...
$con = mysqli_connect('localhost','root','','forums');
...
if (isset($_FILES['Filedata'])) {
    ...
    foreach( $xlsx->rows() as $k => $r) { // LOOP THROUGH EXCEL WORKSHEET
        ...
        $r1 = mysqli_escape_string($con,$r[0]);
        $r2 = mysqli_escape_string($con,$r[1]);
        if ($r[0] != '') {
            $q = "INSERT INTO users(`userid`,`password`,`status`) VALUE('$r1','$r2',0)";
...
if(isset($_POST["ExportType"]))
{
    switch ($_POST['accountStatus']){
        ...
        case 'Y':
            $sql = "SELECT * from users where status = 'Y' order by id asc ";
        break;
        case 'N':
            $sql = "SELECT * from users where status = 'N' order by id asc ";
            break;
    }
    $con->set_charset('utf8');
...
<div class="container-fluid">
    <div class="col-xs-12 col-md-6 col-lg-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><!-- Excel File Uploader -->Upload Users</div>
    ...
    <!--<div class="col-xs-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">행동</div>
                <div class="panel-body">
                    <div class="col-xs-12 col-md-6 col-lg-6">
                        <form action="" method="post">
                            <button type="submit" disabled class="btn btn-warning" name="truncate">트렁크 테이블</button>
                        </form>
                    </div>
                    <div class="col-xs-12 col-md-6 col-lg-6">
                        <div class="btn-group pull-right">
                            ...
                            <button type="button" class="btn btn-info">행동</button>
